...
' Anti-double-launch: match the full dashboard serve.py path. omnialpha's
...
For Each proc In colProcs
    If InStr(LCase(proc.CommandLine), "omnialpha\dashboard\serve.py") > 0 Then
        isRunning = True
    End If
Next

If Not isRunning Then
    WshShell.Run """C:\Python314\pythonw.exe"" C:\ZachAI\omnialpha\dashboard\serve.py", 0, False
End If
