...
# Kelly fraction: 0.05 → 0.10 (2026-05-28), → 0.15 (2026-05-29) — Zach wants
# bigger per-trade dollars. 1.5× bigger stakes → 1.5× bigger wins AND losses,
# deeper drawdowns. Still well under the risk-engine per-trade cap (8% of
# capital ≈ $24 @ $300; this only clips above kelly_fraction ≈ 0.65) and the
# $30 hard cap below. Reconsider if drawdown gets uncomfortable in paper.
DEFAULT_KELLY_FRACTION: float = 0.15
